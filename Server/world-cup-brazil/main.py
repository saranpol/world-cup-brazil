...
class GetStar(webapp2.RequestHandler):
    ...
    def post(self):
        self.process()
    def process(self):
    	star = [{'name':'Angry Vegan Cat','url':'http://world-cup-brazil.appspot.com/images/angry-vegan-cat.jpg'},
    	{'name':'Big Gorilla','url':'http://world-cup-brazil.appspot.com/images/big-gorilla.jpg'},
    	{'name':'Calf\'s Nose','url':'http://world-cup-brazil.appspot.com/images/calfs-nose.jpg'},
    	{'name':'Chubby Cat','url':'http://world-cup-brazil.appspot.com/images/chubby-cat.jpg'},
    	{'name':'Common Buffalo','url':'http://world-cup-brazil.appspot.com/images/common-buffalo.jpg'},
    	{'name':'Constipated Bird','url':'http://world-cup-brazil.appspot.com/images/constipated-bird.jpg'},
    	{'name':'Drug Dog','url':'http://world-cup-brazil.appspot.com/images/drug-dog.jpg'},
    	{'name':'Happy Dog','url':'http://world-cup-brazil.appspot.com/images/happy-dog.jpg'},
    	{'name':'Innocent Flapper','url':'http://world-cup-brazil.appspot.com/images/innocent-flapper.jpg'},
    	{'name':'Melted Dog','url':'http://world-cup-brazil.appspot.com/images/melted-dog.jpg'},
    	{'name':'Nacked Chicken','url':'http://world-cup-brazil.appspot.com/images/nacked-chicken.jpg'},
    	{'name':'Old Monkey','url':'http://world-cup-brazil.appspot.com/images/old-monkey.jpg'},
    	{'name':'Panda','url':'http://world-cup-brazil.appspot.com/images/panda.jpg'},
    	{'name':'Reborn Chimpanzee','url':'http://world-cup-brazil.appspot.com/images/reborn-chimpanzee.jpg'},
    	{'name':'Salamander','url':'http://world-cup-brazil.appspot.com/images/salamander.jpg'},
    	{'name':'Sick Dog','url':'http://world-cup-brazil.appspot.com/images/sick-dog.jpg'},
    	{'name':'Thristy Bear','url':'http://world-cup-brazil.appspot.com/images/thristy-bear.jpg'},
    	{'name':'Toothless Giraffe','url':'http://world-cup-brazil.appspot.com/images/toothless-giraffe.jpg'},
    	{'name':'Unguarded Dog','url':'http://world-cup-brazil.appspot.com/images/unguarded-dog.jpg'},
    	]
