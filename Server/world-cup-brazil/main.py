...
class GetStar(webapp2.RequestHandler):
    ...
    def process(self):
    	...
    	{'name':'Claudio Marchisio.jpg','url':'http://world-cup-brazil.appspot.com/images/Claudio-Marchisio.jpg'},
    	{'name':'Cristiano-Ronaldo.jpg','url':'http://world-cup-brazil.appspot.com/images/Cristiano-Ronaldo.jpg'},
